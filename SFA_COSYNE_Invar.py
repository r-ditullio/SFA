# -*- coding: utf-8 -*-
"""
Created on Thu Oct 17 13:35:48 2019

COSYNE code for invariance (i.e. adjusted to run with different numbers of inputs for training dataset vs testing dataset).
Ultimately should make this fit in with the other code and merge, but for now just going to do this to avoid any dumb problems.
Specifically, the clutter problem can just be run in the old format and then this needs something different.
...
vocal_files_train = ['Stimulus_Set_1/AM_Stimulus_1_1.wav', 'Stimulus_Set_1/AM_Stimulus_2_1.5.wav', 'Stimulus_Set_1/AM_Stimulus_4_2.5.wav', \
                     'Stimulus_Set_1/AM_Stimulus_5_3.wav', 'Stimulus_Set_1/AM_Stimulus_6_3.5.wav','Stimulus_Set_1/AM_Stimulus_8_4.5.wav', \
                     ] #set names of files to be played/trained and tested on #bump examples up to 9 again
vocal_files_test = ['Stimulus_Set_1/AM_Stimulus_2_1.5.wav', 'Stimulus_Set_1/AM_Stimulus_1_1.wav' ]
...
num_samples = num_vocals_train * 5 #choose how many times you see each stimulus
...
SFA_Traj1 = test[0:classifier_features,0:np.shape(vocals_temporal_transformed_test)[2]]
SFA_Traj2 = test[0:classifier_features,np.shape(vocals_temporal_transformed_test)[2] :]
