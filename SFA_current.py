...
vocal_files = ['Stimulus_Set_1/AM_Stimulus_19_10.wav', 'Stimulus_Set_1_c/AM_Stimulus_19_10.wav'] #set names of files to be played/trained and tested on
...
test_noise = True #unclear, I guess toggle for adding unique noise in test case that is different from training case?
...
classifier_features = 4 #how many features from SFA  SFA-Perceptron gets to use
